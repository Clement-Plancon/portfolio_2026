...
class ScrollAnimations {
    constructor() {
        this.elements = document.querySelectorAll('.proj-feat, .proj-card, .skill-card, .skill-block, .principle, .journey-item, .toolbox-group, .signature-item, .purpose, .collab-item, .presence-card, .faq-item, .statement, .running__main, .running__group');
        this.init();
    }
